...
var ctx      = __webpack_require__(23)
  ...
  , toLength = __webpack_require__(3)
...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function world() {
      return (0, _array.find)(this.helloWorld, function (t) {
        return t.text === 'world';
      });
    }
  }]);
...
$export($export.P, 'Array', {copyWithin: __webpack_require__(41)});
...
var $export = __webpack_require__(0)
  , $every  = __webpack_require__(4)(4);

$export($export.P + $export.F * !__webpack_require__(1)([].every, true), 'Array', {
...
$export($export.P, 'Array', {fill: __webpack_require__(42)});
...
var $export = __webpack_require__(0)
  , $filter = __webpack_require__(4)(2);

$export($export.P + $export.F * !__webpack_require__(1)([].filter, true), 'Array', {
...
var $export  = __webpack_require__(0)
  , $forEach = __webpack_require__(4)(0)
  , STRICT   = __webpack_require__(1)([].forEach, true);
...
var $export       = __webpack_require__(0)
  , $indexOf      = __webpack_require__(28)(false)
  , $native       = [].indexOf
  , NEGATIVE_ZERO = !!$native && 1 / [1].indexOf(1, -0) < 0;

$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(1)($native)), 'Array', {
...
$export($export.P + $export.F * (__webpack_require__(17) != Object || !__webpack_require__(1)(arrayJoin)), 'Array', {
...
var $export = __webpack_require__(0)
  , $map    = __webpack_require__(4)(1);

$export($export.P + $export.F * !__webpack_require__(1)([].map, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(1)([].reduceRight, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(1)([].reduce, true), 'Array', {
...
var $export = __webpack_require__(0)
  , $some   = __webpack_require__(4)(3);

$export($export.P + $export.F * !__webpack_require__(1)([].some, true), 'Array', {
...
$export($export.P + $export.F * (fails(function(){
  ...
  test.sort(null);
  // Old WebKit
}) || !__webpack_require__(1)($sort)), 'Array', {
